...
class RotationMats {
    private:
        ...
        VectorND aux0, rot, aux1, aux2, aux3;
        double x, y, z, s, c;
    ...
    public:
        ...
        void rot3DAxe1(VectorND v);
        void rot3DAxe2(VectorND v);
        void rot3DAxe3(VectorND v);
